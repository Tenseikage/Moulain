    ...
    def affiche(self):
        if self.state == '':
            cercle(self.pos[0], self.pos[1], 13, couleur=self.color ,remplissage=self.color, tag=self.tag)
                ...
                image(self.pos[0]+30,self.pos[1]+30, 'Moulain/images_jeu/oreo_n.png', tag=self.tag) #78% 
        elif self.state == 'b':
            image(self.pos[0]+3,self.pos[1]+3, 'Moulain/images_jeu/oreo_b.png', tag=self.tag)
